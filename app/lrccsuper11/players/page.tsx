...
function getCategoryBadge(category: string): { label: string; color: string } {
  switch (category) {
    ...
    case 'APLUS':
      return { label: 'Star Player', color: 'bg-red-500/20 text-red-300 border-red-500/30' };
    case 'BASE':
      return { label: 'League', color: 'bg-white/10 text-white/60 border-white/20' };
    default:
        ...
        <div className="glass rounded-xl p-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {[
              ...
              { key: 'aplus', label: 'Star Players' },
              { key: 'base', label: 'League Players' },
              { key: 'lrcc', label: 'LRCC' },
